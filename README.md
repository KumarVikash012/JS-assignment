...
-  Complexity:
  Each check (reverse + mod) takes log n
  Time: O(n log n) (n ≈ 100000)
##Q4 Fare Calculator
...
-  Complexity:
  Few arithmetic operations, no loops
  Time: O(1)
##Q5 Skipping Numbers
...
-  Complexity:
  Loop until sum ≥ N
  Worst case ~ m iterations where sum grows ~ m²/2
  Time: O(√N)
